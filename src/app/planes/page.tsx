...
const detailedPlans = [
  {
    ...
    fullDesc: 'Diseñado para personas que ya tienen conocimientos o licencia y quieren ganar más seguridad en maniobras complejas, estacionamiento or circular en tráfico.',
    targetAudience: [
