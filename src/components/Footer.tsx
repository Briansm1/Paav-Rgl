  ...
  return (
    <footer className="bg-black text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/#servicios" className="text-slate-400 hover:text-white transition-colors">Metodología</Link></li>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col items-center gap-6 text-slate-500 text-sm text-center uppercase tracking-wider">
