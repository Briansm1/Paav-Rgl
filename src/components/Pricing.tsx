...
const plans = [
  {
    ...
    price: 'Desde $311.999',
    description: 'Ideal para quienes empiezan desde cero o tienen poca experiencia al volante.  Aprendé las bases de la conducción, familiarizate con el vehículo y ganá seguridad paso a paso durante tus primeras clases.',
    badge: 'NIVEL INICIAL',
  ...
  },
  {
    ...
    price: 'Desde $165.999',
    description: 'Pensado para quienes ya tienen experiencia y quieren mejorar su manejo.  Trabajá aspectos específicos de la conducción, reforzá tus habilidades y practicá aquellas situaciones donde necesitás mayor confianza.',
  ...
  },
  {
    ...
    price: 'Desde $86.999',
    description: 'Para alumnos que quieren prepararse antes de rendir el examen práctico.  Practicá maniobras, recorridos y situaciones similares a las del examen para llegar con mayor preparación y tranquilidad.',
