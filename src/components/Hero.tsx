...
export const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative h-[100svh] min-h-[600px] flex flex-col items-center py-24 md:py-32 overflow-hidden">
      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-6 relative z-20 flex-1 flex flex-col justify-between">
        {/* Content Container */}
        <div className="max-w-4xl text-left flex flex-col items-start gap-10 md:gap-10 mt-4 md:mt-8">
