...
export const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative h-[100svh] min-h-[100svh] flex flex-col items-center pt-10 pb-10 md:pt-20 md:pb-16 lg:pt-24 lg:pb-0 overflow-hidden bg-black">
      ...
      <div className="w-full max-w-[1440px] mx-auto px-6 lg:px-10 relative z-20 flex-1 flex flex-col justify-between h-full">
        <div className="w-full flex flex-col md:flex-row justify-between items-center md:items-start gap-4 md:gap-8">
          ...
          {/* Badge (Elevado) */}
          <div className="order-1 md:order-2 inline-block px-4 py-2 text-sm md:text-eyebrow font-bold text-white uppercase tracking-[0.15em] bg-white/10 backdrop-blur-md border border-white/20 rounded-full animate-in fade-in slide-in-from-bottom-4 duration-700 whitespace-nowrap mb-1 md:mb-0">
            Autoescuela en Río Gallegos
          </div>

          {/* Main content block (Elevado) */}
          <div className="order-2 md:order-1 max-w-3xl flex flex-col items-center text-center md:items-start md:text-left gap-4 md:gap-8">
        ...
        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-y-4 gap-x-8 sm:gap-x-10 md:gap-x-14 animate-in fade-in duration-1000 delay-500 pt-8 pb-44 md:pb-28 w-full">
