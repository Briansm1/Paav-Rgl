...
export const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative h-[100svh] min-h-[100svh] flex flex-col items-center overflow-hidden bg-black">
      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 min-[375px]:px-6 lg:px-10 relative z-20 flex-1 flex flex-col justify-center pt-16 min-[375px]:pt-20 md:pt-32 pb-8 md:pb-12">
        <div className="w-full flex flex-col justify-center items-center md:items-start gap-6 min-[375px]:gap-10 md:gap-14">
          ...
          <div className="flex flex-row flex-nowrap items-center justify-center md:justify-start gap-x-4 min-[375px]:gap-x-6 min-[420px]:gap-x-10 sm:gap-x-12 md:gap-x-16 animate-in fade-in duration-1000 delay-500 w-full mt-2 min-[375px]:mt-4 md:mt-12 overflow-visible">
