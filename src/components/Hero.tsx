      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="mt-12 flex flex-wrap items-center gap-6 md:gap-12 animate-in fade-in duration-1000 delay-500">
            <div>
              <p className="text-2xl md:text-4xl font-bold text-foreground">10k+</p>
              <p className="text-xs md:text-sm text-muted-foreground uppercase tracking-wider font-semibold">Alumnos Graduados</p>
            </div>
