...
export const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative h-[100svh] min-h-[100svh] flex flex-col items-center pt-24 pb-10 md:pt-36 md:pb-16 lg:pt-40 lg:pb-0 overflow-hidden bg-black">
