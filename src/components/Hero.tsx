...
export const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative h-[100svh] min-h-[600px] flex flex-col items-center pt-20 md:pt-28 pb-10 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          fill
          className="object-cover blur-[3px] scale-105 opacity-50"
          priority
      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-6 relative z-20 flex-1 flex flex-col justify-between">
        {/* Content Container */}
        <div className="max-w-4xl text-left flex flex-col items-start gap-4 md:gap-8 mt-4 md:mt-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300 w-full sm:w-auto mt-4 md:mt-2">
        ...
        <div className="flex items-center justify-start gap-4 sm:gap-10 md:gap-14 animate-in fade-in duration-1000 delay-500 pt-10 pb-4 md:pb-8">
      ...
      {/* Scroll indicator - Better position and visibility */}
