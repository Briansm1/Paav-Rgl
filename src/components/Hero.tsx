...
export const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative h-[100svh] min-h-[100svh] flex flex-col items-center overflow-hidden bg-black">
      ...
      {/* Content Container */}
      <div className="w-full max-w-[1440px] mx-auto px-4 min-[375px]:px-6 lg:px-10 relative z-20 flex-1 flex flex-col justify-center pt-20 pb-8 md:pt-28 md:pb-8">
        <div className="w-full flex flex-col justify-center items-center md:items-start gap-6 md:gap-10">
          ...
          <div className="w-full flex flex-col items-center text-center md:items-start md:text-left gap-6 md:gap-8">
            <div className="w-full space-y-6 md:space-y-8">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between gap-4 w-full">
                <h1 className="text-[2rem] min-[375px]:text-4xl sm:text-5xl md:text-6xl lg:text-h1 font-display font-semibold text-white drop-shadow-2xl animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-100 leading-[1.1] text-balance text-center md:text-left flex-1 order-last md:order-first">
                ...
                <div className="shrink-0 px-5 py-2 md:px-6 md:py-2.5 text-[11px] sm:text-sm md:text-eyebrow font-bold text-white uppercase tracking-[0.2em] bg-white/10 backdrop-blur-md border border-white/20 rounded-full animate-in fade-in slide-in-from-bottom-4 duration-700 whitespace-nowrap order-first md:order-last md:mt-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300 w-full sm:w-auto">
              <Link href="#planes" className="w-full sm:w-auto">
                <Button size="lg" className="h-14 min-[375px]:h-14 md:h-20 px-10 md:px-14 text-lg min-[375px]:text-lg md:text-2xl bg-primary hover:bg-primary/90 rounded-full w-full font-bold transition-all active:scale-95 shadow-2xl shadow-primary/30 border-none">
                  <span className="inline-flex items-center min-w-[5.5rem] min-[375px]:min-w-[5.5rem] md:min-w-[6.5rem] justify-center">
                    {typedText}
                    <span className="ml-1 w-[2.5px] h-5 md:h-6 bg-white animate-pulse" />
                  </span>
                  <ChevronRight className="ml-2 w-5 h-5 min-[375px]:w-5 min-[375px]:h-5 md:w-8 md:h-8" />
                </Button>
              </Link>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-y-4 gap-x-4 min-[375px]:gap-x-6 sm:gap-x-10 md:gap-x-14 animate-in fade-in duration-1000 delay-500 w-full mt-4 md:mt-8">
            <div className="flex flex-col items-center text-center md:items-start md:text-left">
              ...
              <p className="text-[9px] min-[375px]:text-[9px] sm:text-[10px] md:text-xs lg:text-eyebrow text-white/80 uppercase font-black mt-1 tracking-widest">Certificado ANSV</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center md:items-start md:text-left">
              ...
              <p className="text-[9px] min-[375px]:text-[9px] sm:text-[10px] md:text-xs lg:text-eyebrow text-white/80 uppercase font-black mt-1 tracking-widest">formando pilotos</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center md:items-start md:text-left">
              ...
              <p className="text-[9px] min-[375px]:text-[9px] sm:text-[10px] md:text-xs lg:text-eyebrow text-white/80 uppercase font-black mt-1 tracking-widest">Recomendados</p>
            </div>
          </div>
        </div>
      </div>
