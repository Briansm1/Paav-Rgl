...
export const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative h-[100svh] min-h-[100svh] flex flex-col items-center pt-24 pb-8 md:pt-28 md:pb-12 lg:pt-32 lg:pb-32 overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          fill
          className="object-cover blur-[5px] scale-105 opacity-55"
          priority
      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-6 relative z-20 flex-1 flex flex-col justify-between h-full">
        ...
        <div className="max-w-4xl text-left flex flex-col items-start gap-6 md:gap-10 mt-4 md:mt-3">
          ...
          <div className="space-y-4 md:space-y-8">
            <h1 className="text-4xl sm:text-6xl md:text-5xl lg:text-6xl font-bold font-headline leading-[1.1] md:leading-[1.05] text-white animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-100">
              Tu camino hacia la <span className="text-primary">libertad</span> comienza con nosotros
            </h1>
            
            <p className="text-base sm:text-xl md:text-xl text-white/90 max-w-2xl animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200 leading-relaxed text-left font-medium">
        ...
        {/* Stats Container - Balanced height for mobile screens */}
        <div className="flex items-center justify-start gap-4 sm:gap-10 md:gap-14 animate-in fade-in duration-1000 delay-500 pt-6 pb-12 md:pb-0">
          <div className="flex flex-col items-center text-center min-w-[65px] md:min-w-[100px]">
      ...
      {/* Scroll indicator - Hidden on mobile to avoid overcrowding */}
