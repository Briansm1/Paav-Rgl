  ...
  return (
    <section id="inicio" className="relative h-[100svh] min-h-[100svh] flex flex-col items-center pt-20 pb-0 md:pt-28 md:pb-0 lg:pt-32 lg:pb-0 overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Bottom transition fade - Starts after the yellow items */}
      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-6 relative z-20 flex-1 flex flex-col justify-between h-full">
        {/* Content Container */}
        <div className="max-w-4xl text-left flex flex-col items-start gap-4 md:gap-10 mt-6 md:mt-4">
        ...
        {/* Stats Container - Positioned precisely above the bottom edge */}
