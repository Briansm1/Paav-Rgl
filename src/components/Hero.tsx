...
export const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative h-[100svh] flex flex-col items-center py-20 md:py-32 overflow-hidden">
      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-6 relative z-20 flex-1 flex flex-col justify-between h-full">
        {/* Content Container - mt-[-2rem] for mobile only to lift text as requested */}
        <div className="max-w-4xl text-left flex flex-col items-start gap-6 md:gap-10 -mt-8 md:mt-3">
        ...
        <div className="flex items-center justify-start gap-4 sm:gap-10 md:gap-14 animate-in fade-in duration-1000 delay-500 pt-4 md:pt-8">
          ...
          <div className="flex flex-col items-center text-center min-w-[70px] md:min-w-[100px]">
            <p className="text-base sm:text-xl md:text-3xl font-bold text-gold leading-none">+5 años</p>
          ...
          <div className="flex flex-col items-center text-center min-w-[70px] md:min-w-[100px]">
            <div className="flex flex-col items-center">
              <p className="text-base sm:text-xl md:text-3xl font-bold text-gold leading-none">5/5</p>
