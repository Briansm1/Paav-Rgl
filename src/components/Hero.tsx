    ...
    <section id="inicio" className="relative min-h-[100svh] md:h-screen flex items-center pt-28 md:pt-36 pb-12 overflow-hidden">
      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-6 relative z-20">
        <div className="max-w-4xl text-left">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-headline leading-[1.15] md:leading-[1.1] mb-6 md:mb-6 text-white animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-100">
          ...
          <div className="flex items-center justify-start gap-6 sm:gap-10 md:gap-14 animate-in fade-in duration-1000 delay-500 pb-20 md:pb-0">
            ...
            <div className="text-left">
              ...
              <p className="text-[8px] sm:text-[9px] md:text-[10px] text-white/50 uppercase tracking-[0.2em] font-bold mt-0.5">FORMANDO ASES</p>
            </div>
            ...
            <div className="text-left">
              <div className="flex flex-col items-start">
                ...
                <div className="flex gap-0.5 mt-0.5">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="w-2.5 md:w-3.5 h-2.5 md:h-3.5 text-yellow-400 fill-yellow-400" />
                  ))}
                </div>
              </div>
              <p className="text-[8px] sm:text-[9px] md:text-[10px] text-white/50 uppercase tracking-[0.2em] font-bold mt-0.5">RECOMENDADOS</p>
            </div>
          </div>
        </div>
      </div>
