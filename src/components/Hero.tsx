...
export const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative h-[100svh] min-h-[100svh] flex flex-col items-center pt-32 pb-10 md:pt-44 md:pb-16 overflow-hidden bg-black">
      ...
      <div className="w-full max-w-[1440px] mx-auto px-6 lg:px-10 relative z-20 flex-1 flex flex-col justify-start gap-12 md:gap-16">
        <div className="w-full flex flex-col md:flex-row justify-between items-center md:items-start gap-6 md:gap-8">
          
          {/* Badge */}
          <div className="order-1 md:order-2 inline-block px-4 py-2 text-sm md:text-eyebrow font-bold text-white uppercase tracking-[0.15em] bg-white/10 backdrop-blur-md border border-white/20 rounded-full animate-in fade-in slide-in-from-bottom-4 duration-700 whitespace-nowrap">
        ...
        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-y-6 gap-x-8 sm:gap-x-10 md:gap-x-14 animate-in fade-in duration-1000 delay-500 w-full mt-auto mb-20 md:mb-12">
      ...
      {/* Flecha de scroll desplazada a la izquierda para no tapar contenido */}
